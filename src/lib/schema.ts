...
export const CHARACTER_SCHEMA: SectionDef[] = [
  {
    ...
    fieldCount: 9,
    fields: [
      { id: 'name', label: 'Полное имя', placeholder: 'Анна Сергеевна Ковалёва', type: 'text', row: 1, span: 2 },
      { id: 'age', label: 'Возраст', placeholder: '34', type: 'text', row: 1, span: 1 },
      { id: 'height', label: 'Рост', placeholder: '178 см', type: 'text', row: 1, span: 1 },
      { id: 'build', label: 'Телосложение', placeholder: 'Худощавое, жилистое', type: 'text', row: 2 },
      { id: 'posture', label: 'Осанка', placeholder: 'Сутулится', type: 'text', row: 2 },
      { id: 'hair', label: 'Цвет волос', placeholder: 'Тёмно-русые, до плеч, вечно в пучке', type: 'text', row: 3 },
      { id: 'eyes', label: 'Цвет глаз', placeholder: 'Серо-зелёные, внимательные', type: 'text', row: 3 },

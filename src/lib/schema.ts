...
export const CHARACTER_SCHEMA: SectionDef[] = [
  {
    ...
    fields: [
      ...
      { id: 'build', label: 'Телосложение', placeholder: 'Худощавое, жилистое', type: 'text' },
      { id: 'posture', label: 'Осанка', placeholder: 'Сутулится', type: 'text' },
      { id: 'hair', label: 'Цвет волос', placeholder: 'Тёмно-русые, до плеч, вечно в пучке', type: 'text' },
      { id: 'eyes', label: 'Цвет глаз', placeholder: 'Серо-зелёные, внимательные', type: 'text' },
